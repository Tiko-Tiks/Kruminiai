// Narystės srauto laiškai (dvikalbiai – LT/EN pagal `locale`):
...
//
// Kalba: nario `members.language` laukas (arba registracijos puslapio kalba #1
    ...
    return renderBrandedEmail({
      ...
      body: `
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#fafaf7;border:1px solid #e7e5dd;border-radius:4px;margin:0 0 8px;font-size:14px;">
          <tr>
            <td style="padding:12px 16px 6px;color:#374151;">Joining fee (one-time)</td>
            <td style="padding:12px 16px 6px;text-align:right;font-weight:600;color:#111827;">${ENTRY_FEE_EUR} EUR</td>
          </tr>
          <tr>
            <td style="padding:6px 16px;color:#374151;">${currentYear} membership fee (annual)</td>
            <td style="padding:6px 16px;text-align:right;font-weight:600;color:#111827;">${MEMBERSHIP_FEE_EUR} EUR</td>
          </tr>
          <tr>
            <td style="padding:6px 16px 12px;border-top:1px solid #e7e5dd;font-weight:700;color:#111827;">Total</td>
        ...
        <p style="margin:0 0 16px;font-size:14px;line-height:1.65;color:#4b5563;">
          Once we receive your payment, we will confirm your membership and send you the member portal login details in a separate email.
        </p>
        <p style="margin:0 0 16px;font-size:14px;line-height:1.65;color:#4b5563;">
    ...
    return renderBrandedEmail({
      ...
      body: `
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#f0fdf4;border-left:3px solid #15803d;border-radius:4px;margin:0 0 20px;">
          <tr>
            <td style="padding:18px 22px;">
              <div style="font-size:13px;color:#166534;font-weight:600;text-transform:uppercase;letter-spacing:0.05em;margin-bottom:10px;">Logging in</div>
              <p style="margin:0;font-size:14px;line-height:1.7;color:#374151;">
                Sign in at <a href="${SITE_URL}/prisijungimas" style="color:#15803d;font-weight:600;text-decoration:underline;">kruminiai.lt/prisijungimas</a> with the email and password you chose when registering.
              </p>
            </td>
          </tr>
        </table>
        ...
        <ul style="margin:0 0 20px;padding-left:20px;font-size:14px;line-height:1.8;color:#374151;">
          ...
          <li>update your contact details (<strong>My details</strong>)</li>
        </ul>
        <div style="text-align:center;margin:24px 0;">
          <a href="${SITE_URL}/portalas" style="display:inline-block;background-color:#15803d;color:#ffffff;padding:14px 32px;border-radius:8px;text-decoration:none;font-weight:600;font-size:15px;">Open the member portal</a>
        </div>
        <p style="margin:24px 0 0;font-size:14px;line-height:1.6;color:#6b7280;">
          Questions or suggestions: <a href="mailto:info@kruminiai.lt" style="color:#15803d;">info@kruminiai.lt</a> or +370 658 49514.
        </p>
        <p style="margin:16px 0 0;font-size:15px;line-height:1.7;color:#374151;">
          Warm regards,<br>
          <strong style="font-family:Arial,Helvetica,sans-serif;font-weight:700;font-size:15px;color:#0f3d20;">Krūminiai Village Community</strong>
        </p>
      `,
    });
  }
