...
interface HistoryEntry {
  ...
  attendance_type: "fizinis" | "nuotolinis" | "rastu" | null;
    ...
    <div className="space-y-6">
      ...
      {history.length === 0 ? (
        ...
        <div className="space-y-4">
          {history.map((h) => {
            const liveAttended = h.attendance_type === "fizinis";
            const noVotesRecorded = !h.votes || h.votes.length === 0;
            return (
              <div
                key={h.meeting_id}
              ...
              >
                ...
                {noVotesRecorded ? (
                  // Gyvai dalyvavęs narys – individualūs balsai nesaugomi.
                  // Rodom paaiškinimą ir nuorodą į pilną susirinkimo archyvą.
