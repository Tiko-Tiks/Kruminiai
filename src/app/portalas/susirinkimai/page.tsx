    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Visi bendruomenės narių susirinkimai – darbotvarkės, dokumentai, sprendimai
        </p>
      </div>
        ...
        <div className="space-y-3">
          {meetings.map((m) => (
            <Link
              ...
              className="block bg-white rounded-xl border border-gray-200 hover:border-green-300 hover:shadow-sm transition-all p-5"
            >
