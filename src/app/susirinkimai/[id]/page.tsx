      ...
      <main className="flex-1 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
          ...
          {/* Dalyviai – TIK SKAIČIAI (be vardų/pavardžių pagal GDPR ir
              balsavimo slaptumo principą). Pavardės lieka tik oficialiame
              pasirašytame dalyvių sąrašo PDF, kuris yra atskiras dokumentas
              ir prieinamas tik nariams /dokumentai puslapyje. */}
          {totalAttended > 0 && (
            <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
